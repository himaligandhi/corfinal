...
<head>
    ...
    <title>Types of Loans available</title>
    <!-- Facebook Pixel Code -->
<script>
...
<body id="page-top" class="politics_version">
    ...
    <div class="container" style="font-size: 18px; margin-bottom:80px;">
    <h4 style="margin-top:50px; letter-spacing:1px; color:#8B040B;text-align:center;"><u>THE TYPES OF LOANS AVAILABLE TO SMEs AND WHY EVERY BUSINESS SHOULD BE CONSIDERING BRIDGE LOANS</u></h2>
    <BR>
    ...
    <ul style="margin-left:30px;">
        ...
        <li>
            ...
            Believe it or not, there are some SMEs that are thriving under the current conditions. If your business is one of them, you might be looking to expand and in need of more space. At CORFinancial, we can help you get the financing you need to build your next project. 
        </li>
        <li>
            <strong>
                Working Capital-
            </strong>
            Some businesses are going to need   additional funding, in excess of the Gov’t programs, to fund day to day operations . With creative working capital financing, we can help them do that. 
        </li>
        <li>
            <strong>
                Accounts Receivable Loans-
            </strong>
            The financial challenges of some businesses have been compounded by the fact that they have customers who have not been able to pay their bills. Accounts receivables however are assets which your SME can get a loan against. This can help keep you going until your customers are able to pay. 
        </li>
        <li>
        ...
        Large orders can be problematic for SMEs if they do not have the inventory or the funds to fill the order. Purchase order or inventory financing can help. 
        </li>
    </ul>
   <i>
   ...
   <br>
   <p>
   A <strong>Bridge Loan</strong> is a short-term loan that businesses can use until another expected event happens – such as getting funding from another source, payment on a contract, the sale of property, or re-opening after COVID-19. It is called a bridge loan because it is quite literally meant to bridge the gap. 
   </p>
   <p>
